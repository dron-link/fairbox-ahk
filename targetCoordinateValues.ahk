...
target.normal.vertical := [0, 1] ; for calibration [0, 127], target.format.unitCircle := false
...
target.normal.quadrant := [0.7, 0.7] ; for calibration [90, 90], else if unitCircleFormat then [0.7, 0.7]
